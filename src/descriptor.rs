// From the USB Device Class Definition for Physical Interface Device (PID) Version 1.0.
pub const PID_WHEEL_DESCRIPTOR: &[u8] = &[
...
// A basic joystick descriptor for testing.
pub const _JOYSTICK_DESCRIPTOR: &[u8] = &[
    0x05, 0x01,        // Usage Page (Generic Desktop Ctrls)
    0x09, 0x04,        // Usage (Joystick)
    0xA1, 0x01,        // Collection (Application)
    0x09, 0x01,        //   Usage (Pointer)
